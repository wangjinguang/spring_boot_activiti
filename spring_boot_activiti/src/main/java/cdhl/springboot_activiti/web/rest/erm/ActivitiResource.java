...
public class ActivitiResource {
    ...
    private static Log log = LogFactory.getLog(ActivitiResource.class);
    /**
     * 所有用户
     *
     * @return
    ...
    public ResponseEntity<Object> processList() throws URISyntaxException {
        ...
        for (ProcessDefinition processDefinition : processDefinitionList) {
            ...
            //退单编号
            map.put("refundOrderCode",UUID.randomUUID());
     ...
     * @return
     */
    @RequestMapping(value = "/runing2",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Object> runingProcess2() throws URISyntaxException {
        List list=new ArrayList<>();
...
//    Context.setProcessEngineConfiguration(defaultProcessEngine.getProcessEngineConfiguration());
    ...
    @RequestMapping(value = "/start",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Object> startProcess(String key,String refundOrderCode) throws URISyntaxException {
        String userId=userService.getUserWithAuthorities().getId().toString();
        identityService.setAuthenticatedUserId(userId);
       
        log.info("startProcess method run params key="+key+" userId="+userId+" refundOrderCode="+refundOrderCode);
		
        Map pmap=new HashMap<>();
        pmap.put("startUser",userId);
        pmap.put("refundOrderCode", refundOrderCode);//订单号或者退单号
